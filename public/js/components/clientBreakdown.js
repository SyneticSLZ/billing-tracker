...
export function renderClients(container) {
  container.innerHTML = '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:16px"><h1 style="font-size:16px;font-weight:600">Client Breakdown</h1></div><div id="clients-grid-container"></div><div id="client-detail-container" style="margin-top:16px"></div>';
  ...
  if (!clients.length) { gridContainer.innerHTML = '<div class="empty-state"><h3>No clients</h3><p>Pull data to see client breakdowns.</p></div>'; return; }
